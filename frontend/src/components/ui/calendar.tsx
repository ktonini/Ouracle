...
function Calendar({
    ...
    return (
        <DayPicker
            ...
            classNames={{
                // react-day-picker v9+ renders Nav as a child of Months, so the
                // absolutely positioned arrows need Months as their anchor.
                months: "relative flex flex-col sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0",
                month: "space-y-4",
                month_caption: "flex h-7 justify-center pt-1 relative items-center",
            ...
            components={{
                Chevron: ({ orientation, className, size, style }) => {
